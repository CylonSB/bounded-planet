...
pub fn texture_to_mesh(
    ...
    for z in 0..(land_texture.size.y() as i32) {
        for x in 0..land_texture.size.x() as i32 {
            ...
            //TODO(#0): Use sampler to get mipped height data, rather than using direct data
            land_positions.push([
                x as f32,
            ...
            //TODO(#0): Generate normals based on texture data
...
//TODO(#0): fn pub land_pipeline (Creates a render pipeline set up to use Uint32s for vertex indices)
